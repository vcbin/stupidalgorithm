...
int main(int argc, char *argv[])
{
	...
	try 
	{
		...
		opt_desc.add_options()
			...
			" 5: my dPSO algorithm\n"
			" 6£ºPSObc algorithm\n"
			" 7£ºbasic DE algorithm\n"
			" 8£ºbarebones DE algorithm\n"
			" 9£ºself-adaptive DE algorithm\n"
			" 10£ºmy self-adaptive DE algorithm\n"
			" 11£ºself-adaptive pareto DE algorithm\n"
			" 12£ºself-adaptive jDE algorithm\n"
			" 13£ºfast Evolutionary Programming algorithm\n"
