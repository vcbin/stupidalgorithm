#ifndef JERRYLIU_ALL_ALG_TYPEDEF
#define JERRYLIU_ALL_ALG_TYPEDEF
...
const int min_pso_algo_code=1;
const int max_pso_algo_code=6;
...
inline bool is_pso(int algo_type) { return ((algo_type>=min_pso_algo_code) && (algo_type<=max_pso_algo_code)); }
