...
namespace benchmark
{
	...
	const double func_Mod_Shekel::optimum=std::numeric_limits<double>::lowest();
	const double func_Mod_Langerman::optimum=std::numeric_limits<double>::lowest();
	const double func_Mod_Michalewicz::optimum=std::numeric_limits<double>::lowest();
	const double func_Chebyshev::optimum=std::numeric_limits<double>::lowest();
