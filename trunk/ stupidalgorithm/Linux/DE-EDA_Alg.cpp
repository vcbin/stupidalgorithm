...
namespace de
{
	namespace de_eda
	{
		...
		void de_eda_alg::stat_eda_dist(population &pop)
		{
		...
		double de_eda_alg::gen_eda_x(int dim)
		{
		...
		int de_eda_alg::run()
		{
			...
			for ( m_cur_run=0;m_cur_run<max_run;m_cur_run++ )
			{
				...
				stat_eda_dist(pop);// de_eda SPECIFIC
